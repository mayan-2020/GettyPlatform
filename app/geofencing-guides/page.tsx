...
export default function GeofencingGuides() {
  const geofenceGuides = [
    {
      title: "How to create and manage geofences",
      href: "/geofencing-guides/create-and-manage",
    },
    {
      title: "Generate Email or Fleet app alerts based on Geofence alerts",
      href: "/geofencing-guides/email-sms-alerts",
    },
    {
      title: "How to use route geofences",
      href: "/geofencing-guides/route-geofences",
    },
    {
      title: "Import geofences in KML or CSV format",
      href: "/geofencing-guides/import-kml-csv",
    },
    {
      title: "Export-Import Geofences",
      href: "/geofencing-guides/export-import",
    },
  ]
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-100 to-white">
      ...
      <main className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl font-bold text-slate-800 mb-4">Geofencing Guides</h1>
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">
            Comprehensive guides to help you set up virtual boundaries, manage alerts, and get the most out of your
            geofencing features.
          </p>
        </div>
        ...
        <div className="mb-10">
          <ul className="space-y-3 ml-4">
            {geofenceGuides.map((guide, index) => (
