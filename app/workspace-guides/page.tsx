...
export default function WorkspaceGuides() {
  const workspaceGuides = [
    {
      title: "Customize your Workspace",
      href: "/workspace-guides/customize-workspace",
    },
    {
      title: "Full-screen mode",
      href: "/workspace-guides/full-screen-mode",
    },
    {
      title: "MultiMonitor plugin",
      href: "/workspace-guides/multimonitor-plugin",
    },
    {
      title: "Map Layers",
      href: "/workspace-guides/map-layers",
    },
  ]
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-100 to-white">
      ...
      <main className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl font-bold text-slate-800 mb-4">Workspace Management Guides</h1>
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">
            Comprehensive guides to help you customize your workspace, manage panels, configure display options, and
            optimize your interface for better productivity.
          </p>
        </div>
