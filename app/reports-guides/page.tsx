  ...
  const reportGuides = [
    {
      ...
      href: "/reports-guides/activate-reports",
    },
    {
      title: "Schedule reports to be sent automatically via email",
      href: "/reports-guides/schedule-reports-email",
    },
    {
      title: "Download reports with Excel data",
      href: "/reports-guides/download-excel-data",
    },
  ]
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-100 to-white">
      ...
      <main className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl font-bold text-slate-800 mb-4">Reports & Analytics Guides</h1>
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">
            Comprehensive guides to help you generate, schedule, and export detailed reports and analytics for your
