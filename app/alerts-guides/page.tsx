...
export default function AlertsGuides() {
  const alertGuides = [
    {
      title: "Event Rules introduction",
      href: "/alerts-guides/event-rules-introduction",
    },
    {
      title: "Custom Event Rules wizard: a step-by-step guide",
      href: "/alerts-guides/custom-event-rules-wizard",
    },
    {
      title: "Event Panel Features & Management",
      href: "/alerts-guides/event-panel-features",
    },
    {
    ...
    {
      title: "One-time notifications for repeated asset movement",
      href: "/alerts-guides/one-time-notifications",
    },
    {
      title: "How to clone event rules",
    ...
    {
      title: "Sound Alarm plugin",
      href: "/alerts-guides/sound-alarm-plugin",
    },
  ]
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-100 to-white">
      ...
      <main className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl font-bold text-slate-800 mb-4">Alerts & Event Rules Guides</h1>
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">
            Comprehensive guides to help you set up event rules, configure alerts, and manage notifications for your
